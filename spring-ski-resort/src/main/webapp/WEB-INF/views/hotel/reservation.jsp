			...
			<input name="hotelReserveStayEnd" id="hotelReserveStayEnd" placeholder="투숙종료일" type="hidden">
				...
				<div class="input-group">
					<div class="input-group mb-3">
  						...
  						<input type="text" id="people" class="form-control people"  placeholder="인원수" aria-label="Username" readonly="readonly" onclick="addAudltCnt(0)" aria-describedby="basic-addon1">
